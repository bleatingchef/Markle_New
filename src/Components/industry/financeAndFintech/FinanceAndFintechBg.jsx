...
import finBg from "../../../assets/financeAndFintechImages/financebg.png"

const FinanceAndFintechBg = () => {
    const whoWeServe = [
        'Banks', 'Insurance Companies', 'Lending Companies', 'Payment Service Providers',
        'Investment Companies', 'Fintech Startups', 'Card Companies', 'Financial Software Product Companies'
    ];

    const financialServices = [
        'Underwriting', 'Insurance Analytics', 'Policy Administration', 'AI-powered Underwriting',
        'Loan Management', 'Mortgage Analytics', 'Loan Origination Systems', 'Insurance Software',
    ...
    const customerFacingApps = [
        'Mobile Banking Apps', 'Insurance Apps', 'Lending Apps', 'Buy-Now-Pay-Later Apps'
    ];

    const generalBusinessSoftware = [
        'CRM', 'Accounting Software', 'Document Management', 'Human Resource Management'
    ];

    return (
        <div className="flex flex-col items-center">
            <div className="pr-40 pl-40 pt-20 animate-slideInLeft1">
                <img src={finBg} alt="Frame 1" className="w-[100rem] max-w-full" />
            </div>
            <div className="w-full mt-40 text-center">
                <h1 className="text-3xl md:text-4xl lg:text-7xl text-purple-950 mb-8 text-center">Who We Serve</h1>
...
export default FinanceAndFintechBg