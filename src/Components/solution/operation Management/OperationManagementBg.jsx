...
import operationImg from "../../../assets/industryImages/operationbg.png"


const OperationManagementBg = () => {
    const whoWeServe = [
    ...
    return (
        <div className="flex flex-col items-center">
            <div className="pr-40 pl-40 pt-20 animate-slideInLeft1">
                <img src={operationImg} alt="Frame 1" className="w-[100rem] max-w-full" />
            </div>
...
export default OperationManagementBg