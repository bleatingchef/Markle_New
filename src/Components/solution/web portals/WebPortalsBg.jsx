...
import webPortalImg from "../../../assets/industryImages/webportalbg.png"
    ...
    return (
        <div className="flex flex-col items-center">
            <div className="pr-40 pl-40 pt-20 animate-slideInLeft1">
                <img src={webPortalImg} alt="Frame 1" className="w-[100rem] max-w-full" />
            </div>
